...
VALUES ('Valcke', 'Tristan', 'Trisouille', 't.valcke@students.ephec.be', 'tris.png', 'user123', 'Voici ma bio',
        'Sage comme une image'),
       ('Preat', 'Thomas', 'TomPrt', 'thomas.preat@students.ephec.be', 'thomas.png', 'preat123',
        'Toujours le sourire !', 'Le Charmeur'),
       ('Rocquet', 'Arnaud', 'Rocqnoob', 'arnaud.rocquet@students.ephec.be', 'arnaud.jpg', 'rocquet456',
        'Master en dégustation de pils.', 'Le Stratège'),
       ('Doussis', 'Giorgios', 'GeoTheGreek', 'giorgios.doussis@students.ephec.be', 'giorgios.png', 'greece789',
        'J’amène le soleil avec moi.', 'Le Méditerranéen'),
       ('Kwizera', 'Dorian', 'DKwiz', 'dorian.kwizera@students.ephec.be', 'dorian.jpg', 'kwz321',
        'Toujours partant pour un défi.', 'Le Compétiteur');
